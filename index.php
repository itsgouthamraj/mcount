...
<head>
	<title>Coming Soon - Mathrix'20</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="simpleslide100">
		<div class="simpleslide100-item bg-img1" style="background-image: url('images/COVER.png');"></div>	</div>
	...
	<div class="flex-col-c-sb size1 overlay1">
		...
		<div class="flex-w flex-c-m p-b-35">
			<a href="https://facebook.com/mathrixt20" class="size3 flex-c-m how-social trans-04 m-r-3 m-l-3 m-b-5">
				<i class="fa fa-facebook"></i>
			</a>

			<a href="https://twitter.com/mathrixt20" class="size3 flex-c-m how-social trans-04 m-r-3 m-l-3 m-b-5">
	...
	<script>
		var countDownDate = new Date("Mar 9, 2020 00:00:01").getTime();
